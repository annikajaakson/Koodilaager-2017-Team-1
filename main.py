...
while True:
    ...
    if clicked == True:
        ...
        player_Pos = player.move(Keys[pygame.K_RIGHT] - Keys[pygame.K_LEFT], Keys[pygame.K_DOWN] - Keys[pygame.K_UP],
                                 map1)
        player.draw(screen, player_Pos, Keys[pygame.K_RIGHT] - Keys[pygame.K_LEFT],
                    Keys[pygame.K_DOWN] - Keys[pygame.K_UP])
        cop.update(delta,  map1.path_find(cop.pos(), player_Pos))
        cop.draw(screen)
